...
namespace SemanticVersioning.Tools.Core
{
    public struct SemanticVersion: IComparable, IComparable<SemanticVersion>, IEquatable<SemanticVersion>
    {
        private static readonly Regex SemverRegex = new Regex(@"^(?<major>\d+)\.(?<minor>\d+)\.(?<patch>\d+)(?<prerelease>\-[0-9A-Za-z\-\.]+|)(?<metadata>\+[0-9A-Za-z\-\.]+|)$", RegexOptions.Compiled);
